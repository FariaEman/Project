...
public class Pharmacy {
	...
	public Pharmacy() throws InstantiationException, IllegalAccessException, ClassNotFoundException, IOException {	
	...
	public Sale getSale(int receiptNumber) throws InstantiationException, IllegalAccessException, ClassNotFoundException, IOException {
		receipt=new Receipt();
	...
	void AddRevertedSale(int saleId) throws InstantiationException, IllegalAccessException, ClassNotFoundException, IOException {
	...
	public MedicineCatalog getMedicineCatalog() throws InstantiationException, IllegalAccessException, ClassNotFoundException, IOException {
		medicineCatalog=new MedicineCatalog();
	...
	public void StartPayment(String type) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
		payment=new Payment ();
		payment.SetPaymentHandler(Factory.getInstance().CreatePaymentHandler(type));	
	}
	
	
	public Receipt closeSale() throws InstantiationException, IllegalAccessException, ClassNotFoundException, IOException {
...
public boolean SalesPersonLogin(String username, String password) throws InstantiationException, IllegalAccessException, ClassNotFoundException, IOException
{   
...
public boolean ManagerLogin(String username, String password) throws InstantiationException, IllegalAccessException, ClassNotFoundException, IOException
{   
